...
function ChartLoading() {
  return (
    <div className="flex h-full min-h-32 w-full flex-col gap-2.5">
      ...
      <Skeleton className="h-6 w-full rounded-item-sm opacity-75" />
    </div>
  )
}
...
export function LoadingState({
  ...
  return (
    ...
    >
      ...
      {resolvedVariant === 'inline' && <Skeleton className="h-4 w-20 rounded-item-sm" />}
      {resolvedVariant === 'button' && <Skeleton className="h-4 w-4 rounded-item-sm" />}
    </div>
  )
}
