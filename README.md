...
| ---------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------- |
| `netix-frontend/api`                                                                     | `createHttpClient`, `createMutator`, retry/error/envelope policy, TanStack Query and SWR retry policies, Sentry filter, `buildAuthConfig` + the canonical auth constants, `createDevLoginPrompt` (web dev) | web + RN  |
