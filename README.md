...
| ---------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------- |
| `netix-frontend/api`                                                                     | `createHttpClient`, `createMutator`, retry/error/envelope policy, TanStack Query retry policy, Sentry filter, `buildAuthConfig` + the canonical auth constants, `createDevLoginPrompt` (web dev), `createDevTokenManager` (react-native dev only) | web + RN  |
